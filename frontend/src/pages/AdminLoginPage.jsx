...
const AdminLoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Thông tin Admin không chính xác. Đang chuyển hướng về đăng nhập thường...");
            navigate('/login');
        }
    };
    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex flex-col justify-center items-center relative overflow-hidden">
            ...
            <div className="z-10 w-full max-w-lg p-10 bg-zinc-900/80 backdrop-blur-xl rounded-2xl border border-red-900/50 shadow-2xl shadow-red-900/20">
                <div className="text-center mb-8 flex flex-col items-center">
                    ...
                    <p className="text-zinc-400 text-sm">Chỉ dành cho quản trị viên</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-zinc-300 text-sm font-medium mb-2">Tên đăng nhập Admin</label>
                    ...
                    <div>
                        <label className="block text-zinc-300 text-sm font-medium mb-2">Mã xác nhận Admin</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-red-500">
                                <Lock size={18} />
                            </div>
                    ...
                    >
                        {isLoading ? <Loader2 className="animate-spin" size={18} /> : "Xác thực Admin"}
                    </button>
