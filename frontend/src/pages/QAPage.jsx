...
const QAPage = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!body.trim()) return toast.error("Please write your question");
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex flex-col">
            <header className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur sticky top-0 z-10 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-500">Community Q&A</h1>
                        <p className="text-sm text-zinc-500 dark:text-zinc-400">Ask anything, answer together</p>
                    </div>
                </div>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-3 text-xs text-zinc-500 dark:text-zinc-400">
                                    ...
                                    <span className="flex items-center gap-1">
                                        <MessageSquare size={12} /> {q.answer_count} answers
                                    </span>
                                </div>
                            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl w-full max-w-lg p-6 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium mb-1.5 opacity-80">Your question</label>
                                <textarea
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1.5 opacity-80">Tags (press Enter to add)</label>
                        ...
                        <div className="flex gap-3 mt-6">
                            <button type="button" onClick={() => setIsModalOpen(false)} className="flex-1 py-3 font-semibold bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-xl transition-colors">Cancel</button>
